---
title: "'19 S/W 정보교육 교원 연수"
subtitle: <small> "데이터 과학 시대 재현가능한 글쓰기" </small>
...
![집합연수 프로그램](fig/kofac-2019.png){#id .class width="77%"}
...
![Threats to reproducible science.](fig/threat-to-reproducible-science.png){#id .class width="70%"}
