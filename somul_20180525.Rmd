---
title: "글쓰기는 코딩"
subtitle: "글쓰기를 ~~잘~~하기 위해서 알아야 되는 코딩"
author: "데이터 과학자 이광춘"
date: "2018/05/25"
output:
...
.center[
  <img src="fig/pe-mlb-regression.png" alt="야구 회귀분석 개요" width="100%" />
]

.footnote[
 [회귀분석 - MLB 투수 유전자는 유전이 될까?](http://statkclee.github.io/politics/pe-baseball-era.html)
]
...
.center[
  <img src="fig/data-journalism.png" alt="데이터 저널리즘 그래프" width="70%" />
]

.footnote[
- [제9회 R Meetup 데이터 저널리즘 -백 마디 말보다 그래프 하나](https://github.com/KaggleBreak/xwmooc_Rmeetup)
- [국제노동기구(ILO) 생산가능인구(2000-2017)](https://statkclee.github.io/data-product/data-journalism-working-pop.html)
]
